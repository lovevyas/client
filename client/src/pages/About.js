...
const About = () => {
    return (
        <div class="about">
            ...
            <ul>
                <li><b>Implement Node.js and Express.js</b> for server-side scripting (Completed 9/16/2021)</li>
                <li><b>Implement a database</b> for storage and management of portfolio information(Completed 9/16/2021)</li>
